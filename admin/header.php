...
<head>
    ...
    <title>Admin - Sistem Arsip Digital</title>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="../assets/img/logo/logo1.png" alt="" /></a>
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <div role="menu" class="notification-author dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="notification-menu">
                                                            <?php
                                                            $arsip = mysqli_query($koneksi, "SELECT * FROM riwayat,arsip WHERE riwayat_arsip=arsip_id and riwayat_status='false' ORDER BY riwayat_id DESC");
                                                            while ($p = mysqli_fetch_array($arsip)) {
                                                            ?>
                                                                <li>
                                                                    <a href="riwayat.php?riwayat_id=<?php echo $p['riwayat_id']; ?>">
                                                                        <div class="notification-content">
                                                                            <p>
                                                                                ...
                                                                                <?php if ($p['role'] == 'user') {
                                                                                    ...
                                                                                    echo "Petugas";
                                                                                } ?> dengan nama <b> <?php echo $p['riwayat_nama'] ?></b> telah <?= $p['riwayat_aksi']; ?> <b><?php echo $p['arsip_nama'] ?></b>.
                                                                            </p>
                                                                        </div>
                                                                    </a>
                                                                    <hr>
